...
def Connect(g1, g2, connections, delays, w_mean, w_sd, d_mean, d_sd, syn_model):
    ...
    for i in range(0, len(connections)):
        axon_diameter = np.random.lognormal(np.log(AXON_FAC), d_sd, 1)[0]
        ...
        delay_mm = 1 / np.log(axon_diameter * 2 + 1)*2
