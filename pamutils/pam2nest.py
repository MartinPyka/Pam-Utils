...
def CreateBalancedNetwork(
                          ...
                          delayfile_prefix = ''):
    """ Creates the NEST-network for the dataset generated by PAM
    :param:data         : the network model obtained from PAM
    :params:w_mean, w_sd : mean weights and standard deviation for each mapping or
                           one value for all mappings
    :param:d_mean, d_sd : mean dealy and standard deviation for each mapping or
                          one value for all mappings
    :param:tauMem       : time constant of membrane potential in ms
    :param:theta        : membrane threshold potential in mV
    :param:syn_model    : synapse model
    :param:delayfile_p  : prefix for delay-files. This is output which is needed for 
                          visualization of spikes in Blender using pam_vis
    """
    ...
    # set new parameters for the neuron model with individual defined tauMem and theta.
    # values taken from Brunel, 2000
    neuron_params = {"C_m": 1.,
                     "tau_m" : 20.0, #tauMem,
                     "t_ref":  2.,
                     "E_L" : 0.,
    ...
    # Set new neuron parameters as default for new created neuron models                 
    nest.SetDefaults(neuron_type, neuron_params)
